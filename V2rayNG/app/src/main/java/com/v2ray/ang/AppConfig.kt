...
object AppConfig {
    ...
    const val CACHE_CONNECTION_STARTED_AT = "filvless_connection_started_elapsed_ms"
    ...
    const val TG_CHANNEL_URL = "$APP_URL/issues"
    ...
    const val MSG_CHECK_CONNECTION_HEALTH = 64
    const val MSG_CONNECTION_HEALTH = 63
